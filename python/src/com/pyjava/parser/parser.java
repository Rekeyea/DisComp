...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Jul 11 21:24:01 UYT 2015
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\013\000\002\003\004\000\002\002\004\000\002\002" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\024\045\016\047\004\050\005\051\015\052" +
    "\010\053\013\116\014\117\006\120\012\001\002\000\004" +
    "\041\ufffe\001\002\000\004\041\ufffd\001\002\000\004\041" +
    "\ufff8\001\002\000\004\002\020\001\002\000\004\041\ufffb" +
    "\001\002\000\004\041\017\001\002\000\004\041\ufff7\001" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\016\000\006\002\010\003\006\001\001\000\002\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Object n = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 System.out.println(n); RESULT = ParserStatus.StackGenerador.peek().createName((String)n); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("atom",0, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // program ::= atom NEWLINE 
            {
              Object RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		Object a = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 System.out.println(((Name)a).value); 
